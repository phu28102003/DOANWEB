...
?>
    ...
    <body>
        ...
        <h1 class="container container-fluid text-primary ">Danh sách các Tour</h1>
        <div class="row">
            <div class="col-sm-10"></div>
            <a class="col-sm-1 btn btn-success" href="/website/tour_add.php">Thêm Tour</a></div>
            ...
            <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/../controller/tour_remove_action.php?" class="btn btn-danger">Xóa</a>
                        </td>
                    </tr>
                    <?php 
                            }
